...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EFANVPeermemSpec) DeepCopyInto(out *EFANVPeermemSpec) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EFANVPeermemSpec.
func (in *EFANVPeermemSpec) DeepCopy() *EFANVPeermemSpec {
	if in == nil {
		return nil
	}
	out := new(EFANVPeermemSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EFASpec) DeepCopyInto(out *EFASpec) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EFASpec.
func (in *EFASpec) DeepCopy() *EFASpec {
	if in == nil {
		return nil
	}
	out := new(EFASpec)
...
func (in *NVIDIADriverSpec) DeepCopyInto(out *NVIDIADriverSpec) {
	*out = *in
	...
	if in.EFANVPeermem != nil {
		in, out := &in.EFANVPeermem, &out.EFANVPeermem
		*out = new(EFANVPeermemSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.RDMACore != nil {
		in, out := &in.RDMACore, &out.RDMACore
		*out = new(RDMACoreSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.ImagePullSecrets != nil {
		in, out := &in.ImagePullSecrets, &out.ImagePullSecrets
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RDMACoreSpec) DeepCopyInto(out *RDMACoreSpec) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RDMACoreSpec.
func (in *RDMACoreSpec) DeepCopy() *RDMACoreSpec {
	if in == nil {
		return nil
	}
	out := new(RDMACoreSpec)
